...
interface HabitDayContentProps {
  date: Date
  onConpletedChnaged: (completed: number) => void
}
...
export function HabitDayContent({ date, onConpletedChnaged: onCompletedChange }: HabitDayContentProps) {
